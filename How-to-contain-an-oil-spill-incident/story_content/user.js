...
if (!window.safetyTimer) {
    ...
    window.safetyTimer = setInterval(function () {

        var running = player.GetVar("TimerRunning");
        var timeRemaining = player.GetVar("TimeRemaining");
        var timeLimit = player.GetVar("TimeLimit");
        ...
        if (running && timeRemaining > 0) {
            ...
            var elapsed = timeLimit - timeRemaining;

            player.SetVar("ElapsedTime", elapsed);
            ...
            player.SetVar("TimerDisplay", display);
        ...
        if (timeRemaining <= 0) {
            ...
            player.SetVar("TimeRemaining", 0);
            player.SetVar("ElapsedTime", timeLimit);
